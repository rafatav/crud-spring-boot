package com.group.crud_client.controllers.handlers;

import com.group.crud_client.dto.CustomError;
import com.group.crud_client.dto.FieldMessage;
import com.group.crud_client.dto.ValidationError;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> customName(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        for (FieldError f : e.getBindingResult().getFieldErrors()) {
            err.addErrors(new FieldMessage(f.getField(), f.getDefaultMessage()));
        }
        return ResponseEntity.status(status).body(err);
    }
}
